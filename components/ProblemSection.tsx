...
export function ProblemSection() {
  return (
    <section className="border-b border-neutral-200 bg-[#F2F2F2] py-16 sm:py-24 md:py-32">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 sm:gap-14 sm:px-6 md:px-8 lg:grid-cols-2 lg:gap-20 lg:items-start">
        <FadeIn>
          <p className="text-balance text-2xl font-semibold leading-snug tracking-tight text-neutral-900 sm:text-4xl md:text-5xl md:leading-tight lg:text-[2.85rem] xl:text-[3.25rem]">
